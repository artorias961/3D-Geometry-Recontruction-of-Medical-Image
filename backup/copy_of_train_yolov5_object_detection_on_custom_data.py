...
Original file is located at
    https://colab.research.google.com/drive/1y4pDAuAxtv0Iah5OEgmBf1TgbO_CF5lc
...
rf = Roboflow(api_key="BM0OfqY0PYdwx0iRZ9Ig")
project = rf.workspace("stephreyes").project("senior-design-muy0u")
